...
if ($action == 'trash') {
    ...
    wopdpress_redirect('admin.php?page=wordpress-orders');
    exit();
}
...
<div class="wrap">
    ...
    <ul class="subsubsub">
        <li class="all"><a href="admin.php?page=wordpress-orders" class="current">Tất cả <span class="count">(3)</span></a>
            |</li>
        <li class="publish"><a href="admin.php?page=wordpress-orders&status=pending">Đơn hàng mới</a> |</li>
        <li class="publish"><a href="admin.php?page=wordpress-orders&status=completed">Đơn hàng đã hoàn thành</a> |
        </li>
        <li class="publish"><a href="admin.php?page=wordpress-orders&status=cancled">Đơn hàng đã hủy</a></li>
    </ul>
    <form id="posts-filter" method="get">
        <input type="hidden" name="page" value="wordpress-orders">
        ...
        <div class="tablenav top">
            ...
            <?php
            include WP_ME_PATH . 'includes/templates/elements/paginate.php';
            ?>
            <br class="clear">
        </div>
        ...
        <table class="wp-list-table widefat fixed striped table-view-list posts">
            ...
            <tbody id="the-list">
                <?php foreach ($items as $item) : ?>
                    <tr id="post-<?= $item->id ?>" class="iedit author-self level-0 post-3 status-publish hentry">
                        ...
                        <td class="date column-date"><?= date('d-m-Y', strtotime($item->created_at)) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
