...
<div class="tablenav-pages">
    ...
    <span class="pagination-links">
        <?php if ($paged > 1) : ?>
            <a class="prev-page button" href="admin.php?page=wordpress-orders&paged=<?= $paged - 1; ?>">
        ...
        <?php if ($paged < $total_pages) : ?>
            <a class="next-page button" href="admin.php?page=wordpress-orders&paged=<?= $paged + 1; ?>">
                <span aria-hidden="true">›</span>
            </a>
        <?php endif; ?>
    </span>
